...
pub fn code_to_rule(category: Category, code: &str) -> Option<(RuleGroup, Rule)> {
    ...
    Some(match (category, code) {
        ...
        (Style, "082") => (RuleGroup::Preview, Ast, Default, style::semicolons::MultipleStatementsPerLine),
        (Style, "101") => (RuleGroup::Stable, Text, Default, style::whitespace::TrailingWhitespace),
        (Style, "102") => (RuleGroup::Stable, Ast, Pedantic, style::whitespace::IncorrectSpaceBeforeComment),
        ...
        (Precision, "001") => (RuleGroup::Stable, Ast, Pedantic, precision::kind_suffixes::NoRealSuffix),
        (Precision, "011") => (RuleGroup::Stable, Ast, Pedantic, precision::double_precision::DoublePrecision),
        (Precision, "021") => (RuleGroup::Stable, Ast, Pedantic, precision::implicit_kinds::ImplicitRealKind),
        ...
        (Modules, "022") => (RuleGroup::Preview, Ast, Pedantic, modules::accessibility_statements::DefaultPublicAccessibility),
        (Modules, "031") => (RuleGroup::Preview, Ast, Pedantic, modules::include_statement::IncludeStatement),
        (Modules, "041") => (RuleGroup::Preview, Ast, Pedantic, modules::file_contents::MultipleModules),
        (Modules, "042") => (RuleGroup::Preview, Ast, Pedantic, modules::file_contents::ProgramWithModule),

        (Io, "001") => (RuleGroup::Preview, Ast, Pedantic, io::missing_specifier::MissingActionSpecifier),
        (Io, "011") => (RuleGroup::Preview, Ast, Pedantic, io::magic_io_unit::MagicIoUnit),
        (Io, "012") => (RuleGroup::Preview, Ast, Pedantic, io::magic_io_unit::NonPortableIoUnit),

        (Readability, "001") => (RuleGroup::Preview, Ast, Pedantic, readability::magic_numbers::MagicNumberInArraySize),
