...
| OB061 | [deprecated-character-syntax](rules/deprecated-character-syntax.md) | '{original}' uses outdated syntax | <span title='Rule is stable' style='opacity: 0.6'>✔️</span> <span title='Automatic fix not available' style='opacity: 0.1' aria-hidden='true'>🛠️</span> <span title='Rule turned on by default'>▶️</span> |
