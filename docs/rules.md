...
| FORT003 | [redirected-allow-comment](rules/redirected-allow-comment.md) | `{original}` has been redirected | <span title='Rule is stable' style='opacity: 0.6'>✔️</span> <span title='Automatic fix available'>🛠️</span> <span title='Rule turned on by default'>▶️</span> |
