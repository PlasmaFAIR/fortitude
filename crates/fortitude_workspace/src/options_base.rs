...
impl OptionSet {
    ...
    ///
    /// ```rust
    /// # use fortitude_workspace::options_base::{OptionField, OptionsMetadata, Visit};
    ///
    /// struct WithOptions;
    ///
    ...
    ///
    /// ```rust
    /// # use fortitude_workspace::options_base::{OptionEntry, OptionField, OptionsMetadata, Visit};
    ///
    /// struct WithOptions;
    ///
