...
use crate::rules::portability::{self, invalid_characters};
...
pub struct CheckSettings {
    ...
    pub invalid_tab: invalid_characters::settings::Settings,
}
...
impl CheckSettings {
    fn new(project_root: &Path) -> Self {
        Self {
            ...
            invalid_tab: invalid_characters::settings::Settings::default(),
        }
    }
}
