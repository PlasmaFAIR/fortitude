...
pub mod settings {
    ...
    impl From<stylist::Quote> for Quote {
        fn from(value: stylist::Quote) -> Self {
            match value {
                stylist::Quote::Double => Self::Double,
                stylist::Quote::Single => Self::Single,
            }
        }
    }

    impl Into<stylist::Quote> for Quote {
        fn into(self) -> stylist::Quote {
            match self {
                Self::Double => stylist::Quote::Double,
                Self::Single => stylist::Quote::Single,
            }
        }
    }
