...
mod tests {
    ...
    #[test_case(Rule::EquivalenceStatement, Path::new("OB012.f90"))]
    #[test_case(Rule::BlockDataConstruct, Path::new("OB013.f90"))]
    ...
    #[test_case(Rule::GotoEndDo, Path::new("labelled_do.f90"))]
